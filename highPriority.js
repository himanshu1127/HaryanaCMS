...
const updateData = async (el) => {
  ...
  get("districtName").value = el.rangeDistrictName;
...
const updateComplain = async () => {
  ...
  let obj = {
    ...
    rangeDistrictName: document.getElementById("districtName").value,
...
const viewData = (el) => {
  ...
  get("districtNameView").value = el.rangeDistrictName;
